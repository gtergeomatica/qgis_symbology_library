...
<qgis simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="1" maxScale="0" labelsEnabled="0" minScale="50000" simplifyDrawingHints="1" readOnly="0" simplifyLocal="1" simplifyDrawingTol="1" version="3.12.3-București" styleCategories="AllStyleCategories" simplifyMaxScale="1">
  ...
  <renderer-v2 type="RuleRenderer" enableorderby="0" symbollevels="0" forceraster="0">
    <rules key="{b6ed86b0-0890-40cf-84b4-f8ae39dd9ae1}">
      <rule key="{180b13b3-f67b-4caa-84ff-d281d152b501}" scalemaxdenom="50000" scalemindenom="25000">
        <rule symbol="0" filter="ELSE" key="{f86c8074-ac64-4400-b2f4-abe538355504}" label="Altro o NC"/>
        <rule symbol="1" filter="&quot;d_tipologia&quot; = 1" key="{4a30bcea-7060-4f0d-b987-b705063c85cf}" label="Sospesa"/>
        <rule symbol="2" filter="&quot;d_tipologia&quot; = 2" key="{720f593d-8124-42be-ba5f-36d80658f6d0}" label="A braccio sul palo"/>
        <rule symbol="3" filter="&quot;d_tipologia&quot; = 3" key="{06ead99c-05cd-4f30-ba1e-1c862fa65017}" label="A stelo"/>
      </rule>
      <rule filter=" &quot;d_lato&quot;  =  'DX' " key="{374ce20b-b732-484d-90e6-d1500d5a74a4}" label="Lato destro" scalemaxdenom="25000" scalemindenom="1">
        <rule symbol="4" filter="ELSE" key="{ed0fe388-0767-4e6b-a75d-282f530b1b9f}" label="Altro o NC"/>
        <rule symbol="5" filter="&quot;d_tipologia&quot; = 1" key="{2b99122b-bd6f-42b7-ad96-bd6c3157a1a6}" label="Sospesa"/>
        <rule symbol="6" filter="&quot;d_tipologia&quot; = 2" key="{ef7cef00-f0c3-4ce7-93d6-45192cf277fc}" label="A braccio sul palo"/>
        <rule symbol="7" filter="&quot;d_tipologia&quot; = 3" key="{8b936b9f-6229-4bda-b98e-850605ee23b6}" label="A stelo"/>
      </rule>
      <rule filter=" &quot;d_lato&quot;  =  'SX' " key="{eb54c27c-b740-499f-b8a8-c5f31849a143}" label="Lato sinistro" scalemaxdenom="25000" scalemindenom="1">
        <rule symbol="8" filter="ELSE" key="{e68cb312-5f99-48da-80d1-a8cec701789c}" label="Altro o NC"/>
        <rule symbol="9" filter="&quot;d_tipologia&quot; = 1" key="{6b68dfa9-02c6-480e-8831-8d8d51e62661}" label="Sospesa"/>
        <rule symbol="10" filter="&quot;d_tipologia&quot; = 2" key="{946b04c7-3c96-4dca-aa99-7c28482a3eb7}" label="A braccio sul palo"/>
        <rule symbol="11" filter="&quot;d_tipologia&quot; = 3" key="{10549dae-aef5-475d-973e-1c1b6e8612b9}" label="A stelo"/>
      </rule>
      <rule filter=" &quot;d_lato&quot;  =  'C' " key="{ce1c7e48-d59a-425f-8d18-6588e158021d}" label="Centrale" scalemaxdenom="25000" scalemindenom="1">
        <rule symbol="12" filter="ELSE" key="{9c511af8-a22f-467e-8bdd-7d7c03e6d5d9}" label="Altro o NC"/>
        <rule symbol="13" filter="&quot;d_tipologia&quot; = 1" key="{275a8fd2-9cb7-4769-a412-a1d0194b0c90}" label="Sospesa"/>
        <rule symbol="14" filter="&quot;d_tipologia&quot; = 2" key="{d18c9bcf-4ebf-4f04-90ae-72c4acd98be5}" label="A braccio sul palo"/>
        <rule symbol="15" filter="&quot;d_tipologia&quot; = 3" key="{c1e20979-0f37-42c7-a5df-710f0ea799b2}" label="A stelo"/>
      </rule>
      <rule filter=" &quot;d_lato&quot;  =  'E' " key="{028c980c-253c-414d-b4f9-b293e6d15ee6}" label="Entrambi i lati" scalemaxdenom="25000" scalemindenom="1">
        <rule symbol="16" filter="ELSE" key="{a6c2323f-3bd0-42e6-9599-45c1c03b0c3b}" label="Altro o NC"/>
        <rule symbol="17" filter="&quot;d_tipologia&quot; = 1" key="{6e7ebc4e-428b-4b81-9cda-eb37d01ac1cc}" label="Sospesa"/>
        <rule symbol="18" filter="&quot;d_tipologia&quot; = 2" key="{6cd6e564-a6d9-4a38-9a4b-2d8266c80d44}" label="A braccio sul palo"/>
        <rule symbol="19" filter="&quot;d_tipologia&quot; = 3" key="{489edf53-61cf-41fb-bc1f-edaf0b4c2b1a}" label="A stelo"/>
      </rule>
    </rules>
    <symbols>
      <symbol type="line" name="0" force_rhr="0" alpha="1" clip_to_extent="1">
        <layer locked="0" pass="0" class="SimpleLine" enabled="1">
          ...
          <prop k="line_color" v="255,171,1,255"/>
        ...
        <layer locked="0" pass="0" class="MarkerLine" enabled="1">
          ...
          <symbol type="marker" name="@0@1" force_rhr="0" alpha="1" clip_to_extent="1">
            <layer locked="0" pass="0" class="SimpleMarker" enabled="1">
              ...
              <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
              <prop k="offset_unit" v="MM"/>
              <prop k="outline_color" v="255,171,1,255"/>
      ...
      <symbol type="line" name="11" force_rhr="0" alpha="1" clip_to_extent="1">
        <layer locked="0" pass="0" class="MarkerLine" enabled="1">
          ...
          <symbol type="marker" name="@11@0" force_rhr="0" alpha="1" clip_to_extent="1">
            <layer locked="0" pass="0" class="SimpleMarker" enabled="1">
              <prop k="angle" v="0"/>
              <prop k="color" v="255,171,1,255"/>
              <prop k="horizontal_anchor_point" v="1"/>
      ...
      <symbol type="line" name="19" force_rhr="0" alpha="1" clip_to_extent="1">
        <layer locked="0" pass="0" class="MarkerLine" enabled="1">
          ...
          <symbol type="marker" name="@19@0" force_rhr="0" alpha="1" clip_to_extent="1">
            <layer locked="0" pass="0" class="SimpleMarker" enabled="1">
              <prop k="angle" v="0"/>
              <prop k="color" v="255,171,1,255"/>
              <prop k="horizontal_anchor_point" v="1"/>
      ...
      <symbol type="line" name="7" force_rhr="0" alpha="1" clip_to_extent="1">
        <layer locked="0" pass="0" class="MarkerLine" enabled="1">
          ...
          <symbol type="marker" name="@7@0" force_rhr="0" alpha="1" clip_to_extent="1">
            <layer locked="0" pass="0" class="SimpleMarker" enabled="1">
              <prop k="angle" v="0"/>
              <prop k="color" v="255,171,1,255"/>
              <prop k="horizontal_anchor_point" v="1"/>
  ...
  <fieldConfiguration>
    ...
    <field name="d_tipo_disposizione_lampade">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option type="QString" name="Disposizione laterale" value="1"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Disposizione assiale" value="2"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Disposizione centrale" value="3"/>
              </Option>
              <Option type="Map">
        ...
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              ...
              <Option type="Map">
                <Option type="QString" name="Sospesa" value="1"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="A braccio sul palo" value="2"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="A stelo" value="3"/>
              </Option>
            </Option>
          </Option>
        </config>
  ...
  <aliases>
    ...
    <alias field="d_tipo_disposizione_lampade" name="Disposizione lampade" index="1"/>
    <alias field="d_tipologia" name="Tipologia" index="2"/>
    <alias field="distanza_ciglio_str_cm" name="Distanza dal ciglio (cm)" index="3"/>
  ...
  <defaults>
    ...
    <default field="d_tipo_disposizione_lampade" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint constraints="1" unique_strength="0" field="d_tipo_disposizione_lampade" exp_strength="0" notnull_strength="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="d_tipo_disposizione_lampade" desc=""/>
  ...
  <attributetableconfig sortExpression="&quot;d_tipo_disposizione_lampade&quot;" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      <column type="field" name="d_lato" hidden="0" width="152"/>
      <column type="field" name="d_tipo_disposizione_lampade" hidden="0" width="-1"/>
      <column type="field" name="d_tipologia" hidden="0" width="-1"/>
      <column type="field" name="distanza_ciglio_str_cm" hidden="0" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="d_tipo_disposizione_lampade" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field name="d_tipo_disposizione_lampade" labelOnTop="0"/>
