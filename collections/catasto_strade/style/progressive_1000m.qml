...
<qgis simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="1" maxScale="10000" labelsEnabled="1" minScale="50000" simplifyDrawingHints="0" readOnly="0" simplifyLocal="1" simplifyDrawingTol="1" version="3.12.3-București" styleCategories="AllStyleCategories" simplifyMaxScale="1">
  <flags>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontWordSpacing="0" fontLetterSpacing="0" fontSizeUnit="Point" multilineHeight="1" fontStrikeout="0" blendMode="0" fieldName="prog" previewBkgrdColor="255,255,255,255" fontUnderline="0" useSubstitutions="0" fontFamily="MS Shell Dlg 2" fontCapitals="0" namedStyle="Normale" fontSize="8" textOpacity="1" fontWeight="50" fontItalic="0" isExpression="0" fontKerning="1" textColor="0,0,0,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textOrientation="horizontal">
        <text-buffer bufferSize="0.6" bufferDraw="1" bufferOpacity="1" bufferSizeUnits="MM" bufferJoinStyle="128" bufferBlendMode="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferNoFill="1" bufferColor="255,255,255,255"/>
      ...
      <placement xOffset="0.4" overrunDistance="0" rotationAngle="0" maxCurvedCharAngleOut="-25" repeatDistance="0" dist="0" distMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorType="PointGeometry" geometryGeneratorEnabled="0" yOffset="-0.8" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" preserveRotation="1" offsetType="0" fitInPolygonOnly="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" placement="0" offsetUnits="MM" maxCurvedCharAngleIn="25" centroidInside="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" distUnits="MM" priority="5" repeatDistanceUnits="MM" geometryGenerator="" centroidWhole="0" quadOffset="2" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" placementFlags="10" overrunDistanceUnit="MM" layerType="PointGeometry"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="prog_reale" editable="0"/>
  </editable>
  <labelOnTop>
