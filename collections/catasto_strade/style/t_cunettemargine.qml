...
<qgis simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="1" maxScale="0" labelsEnabled="0" minScale="50000" simplifyDrawingHints="1" readOnly="0" simplifyLocal="1" simplifyDrawingTol="1" version="3.12.3-București" styleCategories="AllStyleCategories" simplifyMaxScale="1">
  ...
  <renderer-v2 type="RuleRenderer" enableorderby="0" symbollevels="0" forceraster="0">
    <rules key="{b76ec593-5d66-426b-b986-74dcc4fac4f8}">
      <rule key="{778ce040-6e6f-4064-94ff-49db04a055ea}" scalemaxdenom="50000" scalemindenom="25000">
        <rule symbol="0" filter="&quot;d_tipo_sagoma&quot; = 1.0000" key="{d4b31ac4-6fe9-462d-a679-3814305dd299}" label="Trapezia"/>
        <rule symbol="1" filter="&quot;d_tipo_sagoma&quot; = 2.0000" key="{14ed7fb5-23ba-42d8-83fe-39c77977a439}" label="a L (francese)"/>
        <rule symbol="2" filter=" &quot;d_tipo_sagoma&quot;  = 3.0000" key="{94f8df9c-5b86-4b27-b089-23ecdc245ef2}" label="Triangolare"/>
        <rule symbol="3" filter=" &quot;d_tipo_sagoma&quot;  = 4.0000" key="{b3efe768-ef64-452a-8ee1-9368c3ec6f11}" label="A profilo curvo"/>
        <rule symbol="4" filter="ELSE" key="{2352c549-b125-415d-93aa-d27a4648bf16}" label="Altro o NC"/>
      </rule>
      <rule filter=" &quot;d_lato&quot;  =  'DX' " key="{3b3f2fc3-8e04-4e75-82c0-9d8bdada35ae}" label="Lato destro" scalemaxdenom="25000" scalemindenom="1">
        <rule symbol="5" filter="&quot;d_tipo_sagoma&quot; = 1.0000" key="{cc58b96f-3530-46df-a77e-c9c8f106baf7}" label="Trapezia"/>
        <rule symbol="6" filter="&quot;d_tipo_sagoma&quot; = 2.0000" key="{c7dd5783-4d65-4799-98c2-ef9d49d8240f}" label="a L (francese)"/>
        <rule symbol="7" filter=" &quot;d_tipo_sagoma&quot;  = 3.0000" key="{43c34f5e-ccb9-4396-975d-7a69cd876c2b}" label="Triangolare"/>
        <rule symbol="8" filter=" &quot;d_tipo_sagoma&quot;  = 4.0000" key="{e3914053-58bd-4d09-8a38-38c4cd46ced8}" label="A profilo curvo"/>
        <rule symbol="9" filter="ELSE" key="{ce60ceaa-4e5c-40bf-945a-82cd3a2bf845}" label="Altro o NC"/>
      </rule>
      <rule filter=" &quot;d_lato&quot;  =  'SX' " key="{ea53201d-1767-4bae-85c7-8aae0895e1e1}" label="Lato sinistro" scalemaxdenom="25000" scalemindenom="1">
        <rule symbol="10" filter="&quot;d_tipo_sagoma&quot; = 1.0000" key="{9cc268e0-844c-4215-bc71-c14c43235d23}" label="Trapezia"/>
        <rule symbol="11" filter="&quot;d_tipo_sagoma&quot; = 2.0000" key="{06bbd0f4-2e1e-4cc4-a4fc-06a4b359eb3f}" label="a L (francese)"/>
        <rule symbol="12" filter=" &quot;d_tipo_sagoma&quot;  = 3.0000" key="{eb4654d9-956a-4016-8c58-54ce6bd5f40e}" label="Triangolare"/>
        <rule symbol="13" filter=" &quot;d_tipo_sagoma&quot;  = 4.0000" key="{730b534e-8022-4593-9ae7-f06a2c8df3f3}" label="A profilo curvo"/>
        <rule symbol="14" filter="ELSE" key="{7f1bcb4a-4955-4bf0-8e72-05e71f3d8df2}" label="Altro o NC"/>
      </rule>
      <rule filter=" &quot;d_lato&quot;  =  'C' " key="{03e7dbd9-3655-4aad-a251-a0b7e95ce1dd}" label="Centrale" scalemaxdenom="25000" scalemindenom="1">
        <rule symbol="15" filter="&quot;d_tipo_sagoma&quot; = 1.0000" key="{cd6ccdb2-4564-43bc-a7cd-f9c70560d302}" label="Trapezia"/>
        <rule symbol="16" filter="&quot;d_tipo_sagoma&quot; = 2.0000" key="{01b553d0-726b-45f0-bad0-5f29feed225f}" label="a L (francese)"/>
        <rule symbol="17" filter=" &quot;d_tipo_sagoma&quot;  = 3.0000" key="{416b6a42-b01e-4452-880c-ee1df3b86a54}" label="Triangolare"/>
        <rule symbol="18" filter=" &quot;d_tipo_sagoma&quot;  = 4.0000" key="{3ecb9989-2365-4d0c-ba89-df038c97fb72}" label="A profilo curvo"/>
        <rule symbol="19" filter="ELSE" key="{fb2b6959-1975-4327-a667-e1a1238d1725}" label="Altro o NC"/>
      </rule>
      <rule filter=" &quot;d_lato&quot;  =  'E' " key="{48eb5068-6efd-4a75-9815-fe0ee9d24c95}" label="Entrambi i lati" scalemaxdenom="25000" scalemindenom="1">
        <rule symbol="20" filter="&quot;d_tipo_sagoma&quot; = 1.0000" key="{c598c509-795b-4d37-a53b-2188aa4b7207}" label="Trapezia"/>
        <rule symbol="21" filter="&quot;d_tipo_sagoma&quot; = 2.0000" key="{7ddd378b-936b-4c1f-8f77-7098c9b9a3d3}" label="a L (francese)"/>
        <rule symbol="22" filter=" &quot;d_tipo_sagoma&quot;  = 3.0000" key="{36aa49d9-4d6d-499a-afca-a17808713a4f}" label="Triangolare"/>
        <rule symbol="23" filter=" &quot;d_tipo_sagoma&quot;  = 4.0000" key="{2436572a-8d93-47a1-80f1-037864cffc89}" label="A profilo curvo"/>
        <rule symbol="24" filter="ELSE" key="{ce42dfb8-9288-4cff-9bdd-25a0ff27606d}" label="Altro o NC"/>
      </rule>
    </rules>
    <symbols>
      <symbol type="line" name="0" force_rhr="0" alpha="1" clip_to_extent="1">
        <layer locked="0" pass="0" class="SimpleLine" enabled="1">
          ...
          <prop k="line_color" v="1,166,255,255"/>
        ...
        <layer locked="0" pass="0" class="MarkerLine" enabled="1">
          ...
          <symbol type="marker" name="@0@1" force_rhr="0" alpha="1" clip_to_extent="1">
            <layer locked="0" pass="0" class="SimpleMarker" enabled="1">
              ...
              <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
              <prop k="offset_unit" v="MM"/>
              <prop k="outline_color" v="1,166,255,255"/>
        ...
        <layer locked="0" pass="0" class="MarkerLine" enabled="1">
          ...
          <symbol type="marker" name="@1@1" force_rhr="0" alpha="1" clip_to_extent="1">
            <layer locked="0" pass="0" class="FontMarker" enabled="1">
              ...
              <prop k="horizontal_anchor_point" v="1"/>
              <prop k="joinstyle" v="bevel"/>
              <prop k="offset" v="0,-0.60000000000000009"/>
              <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
              <prop k="offset_unit" v="MM"/>
  ...
  <fieldConfiguration>
    ...
    <field name="d_tipo_sagoma">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option type="QString" name="A L (francese)" value="2"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="A profilo curvo" value="4"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Altro" value="5"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Trapezia" value="1"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Trinagolare" value="3"/>
              </Option>
            </Option>
          </Option>
        </config>
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option type="QString" name="Cls" value="2"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Muratura in pietrame" value="1"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Terreno naturale" value="3"/>
              </Option>
            </Option>
          </Option>
        </config>
  ...
  <aliases>
    ...
    <alias field="d_tipo_sagoma" name="Tipologia sagoma" index="1"/>
    <alias field="largh_max_cm" name="Larghezza massima (cm)" index="2"/>
    <alias field="d_materiale" name="Materiale" index="3"/>
  ...
  <defaults>
    ...
    <default field="d_tipo_sagoma" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint constraints="1" unique_strength="0" field="d_tipo_sagoma" exp_strength="0" notnull_strength="1"/>
    <constraint constraints="0" unique_strength="0" field="largh_max_cm" exp_strength="0" notnull_strength="0"/>
    <constraint constraints="1" unique_strength="0" field="d_materiale" exp_strength="0" notnull_strength="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="d_tipo_sagoma" desc=""/>
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      <column type="field" name="d_lato" hidden="0" width="345"/>
      <column type="field" name="d_tipo_sagoma" hidden="0" width="-1"/>
      <column type="field" name="largh_max_cm" hidden="0" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="d_tipo_sagoma" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field name="d_tipo_sagoma" labelOnTop="0"/>
