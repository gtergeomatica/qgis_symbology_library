...
<qgis simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="1" maxScale="0" labelsEnabled="0" minScale="50000" simplifyDrawingHints="1" readOnly="0" simplifyLocal="1" simplifyDrawingTol="1" version="3.12.3-București" styleCategories="AllStyleCategories" simplifyMaxScale="1">
  ...
  <renderer-v2 type="RuleRenderer" enableorderby="0" symbollevels="0" forceraster="0">
    <rules key="{fe3b3d7b-4bea-4735-aebb-0678e15460c5}">
      <rule symbol="0" filter="&quot;d_tipo&quot; = 1" key="{436a69a5-081c-432e-a9f8-109882ed3935}" label="Non automatici (PL)"/>
      <rule symbol="1" filter="&quot;d_tipo&quot; = 2" key="{d1c8cc83-0961-4da1-bcbc-d7017de04f00}" label="Automatici (PLA)"/>
      <rule symbol="2" filter="&quot;d_tipo&quot; = 3" key="{aca7df38-783f-48d8-83c8-dd772454c796}" label="Privati (PR)"/>
      <rule symbol="3" filter="ELSE" key="{aebacd7e-d56e-4b26-b362-02c4e9b587f5}" label="Altro o NC"/>
    </rules>
    <symbols>
      <symbol type="line" name="0" force_rhr="0" alpha="1" clip_to_extent="1">
        ...
        <layer locked="0" pass="0" class="MarkerLine" enabled="1">
          ...
          <symbol type="marker" name="@0@2" force_rhr="0" alpha="1" clip_to_extent="1">
            <layer locked="0" pass="0" class="SvgMarker" enabled="1">
              <prop k="angle" v="0"/>
              <prop k="color" v="0,0,0,255"/>
              <prop k="fixedAspectRatio" v="0"/>
              <prop k="horizontal_anchor_point" v="1"/>
              <prop k="name" v="Z:/NuovoCS/progetti_privati/media/Resource Sharing/svg/gpsicons/couple.svg"/>
              <prop k="offset" v="0,0"/>
              <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
              <prop k="offset_unit" v="MM"/>
      ...
      <symbol type="line" name="1" force_rhr="0" alpha="1" clip_to_extent="1">
        ...
        <layer locked="0" pass="0" class="MarkerLine" enabled="1">
          ...
          <symbol type="marker" name="@1@2" force_rhr="0" alpha="1" clip_to_extent="1">
            <layer locked="0" pass="0" class="SvgMarker" enabled="1">
              <prop k="angle" v="0"/>
              <prop k="color" v="0,0,0,255"/>
              <prop k="fixedAspectRatio" v="0"/>
              <prop k="horizontal_anchor_point" v="1"/>
              <prop k="name" v="Z:/NuovoCS/progetti_privati/media/Resource Sharing/svg/tourist/tourist_view_point.svg"/>
              <prop k="offset" v="0,0"/>
              <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
              <prop k="offset_unit" v="MM"/>
      ...
      <symbol type="line" name="2" force_rhr="0" alpha="1" clip_to_extent="1">
        ...
        <layer locked="0" pass="0" class="MarkerLine" enabled="1">
          ...
          <symbol type="marker" name="@2@2" force_rhr="0" alpha="1" clip_to_extent="1">
            <layer locked="0" pass="0" class="SvgMarker" enabled="1">
              <prop k="angle" v="0"/>
              <prop k="color" v="0,0,0,255"/>
              <prop k="fixedAspectRatio" v="0"/>
      ...
      <symbol type="line" name="3" force_rhr="0" alpha="1" clip_to_extent="1">
        ...
        <layer locked="0" pass="0" class="MarkerLine" enabled="1">
          ...
          <symbol type="marker" name="@3@2" force_rhr="0" alpha="1" clip_to_extent="1">
        ...
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              ...
              <Option type="Map">
                <Option type="QString" name="Automatici (PLA)" value="2"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Non automatici (PL)" value="1"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Privati (PR)" value="3"/>
              </Option>
            </Option>
          </Option>
        </config>
  ...
  <aliases>
    ...
    <alias field="d_tipo" name="Tipologia" index="1"/>
    <alias field="numero_binari" name="Numero binari" index="2"/>
    <alias field="distparz_i" name="Distanza parziale iniziale" index="3"/>
    <alias field="prog_ini" name="Progressiva iniziale" index="4"/>
    <alias field="prog_ini_storico" name="" index="5"/>
    <alias field="distparz_f" name="Distanza parziale finale" index="6"/>
    <alias field="prog_fin" name="Progressiva finale" index="7"/>
    <alias field="prog_fin_storico" name="" index="8"/>
    <alias field="d_origine" name="Origine del dato" index="9"/>
    <alias field="cod_strada" name="Codice strada" index="10"/>
    <alias field="datains" name="Data inserimento" index="11"/>
    <alias field="dataagg" name="Data aggiornamento" index="12"/>
    <alias field="data_elimi" name="Data eliminazione" index="13"/>
    <alias field="note_" name="Note" index="14"/>
    <alias field="id" name="" index="15"/>
    <alias field="prog_ini_reale" name="" index="16"/>
    <alias field="prog_fin_reale" name="" index="17"/>
    <alias field="login" name="Utente ultima modifica" index="18"/>
    <alias field="lunghezza" name="Lunghezza geometria (m)" index="19"/>
  </aliases>
  ...
  <defaults>
    ...
    <default field="d_tipo" expression="" applyOnUpdate="0"/>
    <default field="numero_binari" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint constraints="1" unique_strength="0" field="d_tipo" exp_strength="0" notnull_strength="1"/>
    <constraint constraints="0" unique_strength="0" field="numero_binari" exp_strength="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="d_tipo" desc=""/>
    <constraint exp="" field="numero_binari" desc=""/>
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column type="field" name="d_tipo" hidden="0" width="-1"/>
      <column type="field" name="numero_binari" hidden="0" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="numero_binari" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field name="d_tipo" labelOnTop="0"/>
    ...
    <field name="numero_binari" labelOnTop="0"/>
