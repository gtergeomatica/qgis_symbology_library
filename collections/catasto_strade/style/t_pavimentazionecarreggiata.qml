...
<qgis simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="1" maxScale="0" labelsEnabled="0" minScale="50000" simplifyDrawingHints="1" readOnly="0" simplifyLocal="1" simplifyDrawingTol="1" version="3.12.3-București" styleCategories="AllStyleCategories" simplifyMaxScale="1">
  ...
  <fieldConfiguration>
    ...
    <field name="d_tipo_sovrastruttura">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option type="QString" name="Altro - sterrata" value="4"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Sovrastruttura flessibile" value="3"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Sovrastruttura rigida" value="1"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Sovrastruttura semirigida" value="2"/>
              </Option>
            </Option>
          </Option>
        </config>
    ...
    <field name="d_tipo_pavimentazione">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              ...
              <Option type="Map">
                <Option type="QString" name="Conglomerato bituminoso" value="1"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Calcestruzzo non armato" value="2"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Calcestruzzo ad armatura non continua" value="3"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Pavimentazione in c.a.p." value="4"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Massicciata in macadam" value="5"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Massicciata con trattamento superficiale" value="6"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Massicciata a penetrazione" value="7"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Pavimentazione con tasselli autobloccanti di cls" value="8"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Pavimentazione ad elementi" value="9"/>
              </Option>
            </Option>
          </Option>
        </config>
  ...
  <aliases>
    ...
    <alias field="d_tipo_sovrastruttura" name="Tipologia sovrastruttura" index="1"/>
    <alias field="d_tipo_pavimentazione" name="Tipologia pavimentazione" index="2"/>
    ...
    <alias field="d_origine" name="Origine" index="9"/>
  ...
  <defaults>
    ...
    <default field="d_tipo_sovrastruttura" expression="" applyOnUpdate="0"/>
    <default field="d_tipo_pavimentazione" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint constraints="1" unique_strength="0" field="d_tipo_sovrastruttura" exp_strength="0" notnull_strength="1"/>
    <constraint constraints="1" unique_strength="0" field="d_tipo_pavimentazione" exp_strength="0" notnull_strength="1"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="d_tipo_sovrastruttura" desc=""/>
    <constraint exp="" field="d_tipo_pavimentazione" desc=""/>
  ...
  <attributetableconfig sortExpression="&quot;d_origine&quot;" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column type="field" name="d_tipo_sovrastruttura" hidden="0" width="-1"/>
      <column type="field" name="d_tipo_pavimentazione" hidden="0" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="d_tipo_pavimentazione" editable="1"/>
    <field name="d_tipo_sovrastruttura" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field name="d_tipo_pavimentazione" labelOnTop="0"/>
    <field name="d_tipo_sovrastruttura" labelOnTop="0"/>
