...
<qgis simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="1" maxScale="0" labelsEnabled="0" minScale="50000" simplifyDrawingHints="1" readOnly="0" simplifyLocal="1" simplifyDrawingTol="1" version="3.12.3-București" styleCategories="AllStyleCategories" simplifyMaxScale="1">
    ...
    <symbols>
      <symbol type="line" name="0" force_rhr="0" alpha="1" clip_to_extent="1">
        <layer locked="0" pass="0" class="SimpleLine" enabled="1">
          ...
          <prop k="line_color" v="163,108,71,255"/>
  ...
  <fieldConfiguration>
    ...
    <field name="d_tipo_carreggiata">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option type="QString" name="Carreggiata separata con segnaletica" value="1"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Carreggiata separata con spartitraffico invalicabile" value="2"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Carreggiata unica" value="0"/>
              </Option>
            </Option>
          </Option>
        </config>
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option type="QString" name="banchina" value="1"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="banchina + fascia di sosta laterale o fermata" value="4"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="corsia di emergenza" value="2"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="fascia di sosta laterale o fermata" value="3"/>
              </Option>
              <Option type="Map">
    ...
    <field name="d_tipo_spartitraffico">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option type="QString" name="separazione con segnaletica&#xa;" value="3"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="separazione fisica non valicabile&#xa;" value="1"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="separazione fisica valicabile" value="2"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Altro" value="-1"/>
              </Option>
    ...
    <field name="largh_spartitraffico_cm">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
  ...
  <aliases>
    ...
    <alias field="d_tipo_carreggiata" name="Tipologia carreggiata" index="2"/>
    <alias field="d_franco" name="Franco" index="3"/>
    <alias field="largh_franco_cm" name="Larghezza franco (cm)" index="4"/>
    <alias field="d_franco_dx" name="Franco destro" index="5"/>
    <alias field="largh_franco_dx_cm" name="Larghezza franco destro (cm)" index="6"/>
    <alias field="d_franco_sx" name="Franco sinistro" index="7"/>
    <alias field="largh_franco_sx_cm" name="Larghezza franco sx (cm)" index="8"/>
    <alias field="d_tipo_spartitraffico" name="Tipologia spartitraffico" index="9"/>
    <alias field="largh_spartitraffico_cm" name="Larghezza spartitraffico (cm)" index="10"/>
    <alias field="numero_corsie_dx" name="Numero corsie a destra" index="11"/>
    <alias field="numero_corsie_sx" name="Numero corsie a sinistra" index="12"/>
    <alias field="distparz_i" name="Distanza parziale niziale" index="13"/>
    ...
    <alias field="lunghezza" name="Lunghezza geometria (m)" index="29"/>
  </aliases>
  ...
  <defaults>
    ...
    <default field="d_tipo_carreggiata" expression="" applyOnUpdate="0"/>
    <default field="d_franco" expression="" applyOnUpdate="0"/>
    <default field="largh_franco_cm" expression="" applyOnUpdate="0"/>
    <default field="d_franco_dx" expression="" applyOnUpdate="0"/>
    <default field="largh_franco_dx_cm" expression="" applyOnUpdate="0"/>
    <default field="d_franco_sx" expression="" applyOnUpdate="0"/>
    <default field="largh_franco_sx_cm" expression="" applyOnUpdate="0"/>
    <default field="d_tipo_spartitraffico" expression="" applyOnUpdate="0"/>
    <default field="largh_spartitraffico_cm" expression="" applyOnUpdate="0"/>
    <default field="numero_corsie_dx" expression="" applyOnUpdate="0"/>
    <default field="numero_corsie_sx" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint constraints="1" unique_strength="0" field="d_tipo_carreggiata" exp_strength="0" notnull_strength="1"/>
    <constraint constraints="1" unique_strength="0" field="d_franco" exp_strength="0" notnull_strength="1"/>
    <constraint constraints="0" unique_strength="0" field="largh_franco_cm" exp_strength="0" notnull_strength="0"/>
    <constraint constraints="1" unique_strength="0" field="d_franco_dx" exp_strength="0" notnull_strength="1"/>
    <constraint constraints="0" unique_strength="0" field="largh_franco_dx_cm" exp_strength="0" notnull_strength="0"/>
    <constraint constraints="1" unique_strength="0" field="d_franco_sx" exp_strength="0" notnull_strength="1"/>
    <constraint constraints="0" unique_strength="0" field="largh_franco_sx_cm" exp_strength="0" notnull_strength="0"/>
    <constraint constraints="1" unique_strength="0" field="d_tipo_spartitraffico" exp_strength="0" notnull_strength="1"/>
    <constraint constraints="0" unique_strength="0" field="largh_spartitraffico_cm" exp_strength="0" notnull_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="numero_corsie_dx" exp_strength="0" notnull_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="numero_corsie_sx" exp_strength="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="d_tipo_carreggiata" desc=""/>
    <constraint exp="" field="d_franco" desc=""/>
    <constraint exp="" field="largh_franco_cm" desc=""/>
    <constraint exp="" field="d_franco_dx" desc=""/>
    <constraint exp="" field="largh_franco_dx_cm" desc=""/>
    <constraint exp="" field="d_franco_sx" desc=""/>
    <constraint exp="" field="largh_franco_sx_cm" desc=""/>
    <constraint exp="" field="d_tipo_spartitraffico" desc=""/>
    <constraint exp="" field="largh_spartitraffico_cm" desc=""/>
    <constraint exp="" field="numero_corsie_dx" desc=""/>
    <constraint exp="" field="numero_corsie_sx" desc=""/>
  ...
  <attributetableconfig sortExpression="&quot;d_franco&quot;" actionWidgetStyle="dropDown" sortOrder="1">
    <columns>
      <column type="field" name="d_lato" hidden="0" width="-1"/>
      <column type="field" name="largh_cm" hidden="0" width="-1"/>
      <column type="field" name="d_tipo_carreggiata" hidden="0" width="425"/>
      <column type="field" name="d_franco" hidden="0" width="-1"/>
      <column type="field" name="largh_franco_cm" hidden="0" width="-1"/>
      <column type="field" name="d_franco_dx" hidden="0" width="-1"/>
      <column type="field" name="largh_franco_dx_cm" hidden="0" width="224"/>
      <column type="field" name="d_franco_sx" hidden="0" width="-1"/>
      <column type="field" name="largh_franco_sx_cm" hidden="0" width="-1"/>
      <column type="field" name="d_tipo_spartitraffico" hidden="0" width="-1"/>
      <column type="field" name="largh_spartitraffico_cm" hidden="0" width="-1"/>
      <column type="field" name="numero_corsie_dx" hidden="0" width="-1"/>
      <column type="field" name="numero_corsie_sx" hidden="0" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="d_franco" editable="1"/>
    <field name="d_franco_dx" editable="1"/>
    <field name="d_franco_sx" editable="1"/>
    <field name="d_lato" editable="1"/>
    <field name="d_origine" editable="1"/>
    <field name="d_tipo_carreggiata" editable="1"/>
    <field name="d_tipo_spartitraffico" editable="1"/>
    ...
    <field name="largh_franco_cm" editable="1"/>
    <field name="largh_franco_dx_cm" editable="1"/>
    <field name="largh_franco_sx_cm" editable="1"/>
    <field name="largh_spartitraffico_cm" editable="1"/>
    <field name="login" editable="1"/>
    <field name="lunghezza" editable="0"/>
    <field name="note_" editable="1"/>
    <field name="numero_corsie_dx" editable="1"/>
    <field name="numero_corsie_sx" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field name="d_franco" labelOnTop="0"/>
    <field name="d_franco_dx" labelOnTop="0"/>
    <field name="d_franco_sx" labelOnTop="0"/>
    <field name="d_lato" labelOnTop="0"/>
    <field name="d_origine" labelOnTop="0"/>
    <field name="d_tipo_carreggiata" labelOnTop="0"/>
    <field name="d_tipo_spartitraffico" labelOnTop="0"/>
    ...
    <field name="largh_franco_cm" labelOnTop="0"/>
    <field name="largh_franco_dx_cm" labelOnTop="0"/>
    <field name="largh_franco_sx_cm" labelOnTop="0"/>
    <field name="largh_spartitraffico_cm" labelOnTop="0"/>
    <field name="login" labelOnTop="0"/>
    <field name="lunghezza" labelOnTop="0"/>
    <field name="note_" labelOnTop="0"/>
    <field name="numero_corsie_dx" labelOnTop="0"/>
    <field name="numero_corsie_sx" labelOnTop="0"/>
