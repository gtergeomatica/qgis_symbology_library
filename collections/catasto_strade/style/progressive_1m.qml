...
<qgis simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="1" maxScale="0" labelsEnabled="1" minScale="250" simplifyDrawingHints="0" readOnly="0" simplifyLocal="1" simplifyDrawingTol="1" version="3.12.3-București" styleCategories="AllStyleCategories" simplifyMaxScale="1">
  <flags>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontWordSpacing="0" fontLetterSpacing="0" fontSizeUnit="Point" multilineHeight="1" fontStrikeout="0" blendMode="0" fieldName="prog" previewBkgrdColor="255,255,255,255" fontUnderline="0" useSubstitutions="0" fontFamily="MS Shell Dlg 2" fontCapitals="0" namedStyle="Normale" fontSize="8" textOpacity="1" fontWeight="50" fontItalic="0" isExpression="0" fontKerning="1" textColor="0,0,0,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textOrientation="horizontal">
        <text-buffer bufferSize="0.5" bufferDraw="1" bufferOpacity="1" bufferSizeUnits="MM" bufferJoinStyle="128" bufferBlendMode="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferNoFill="1" bufferColor="255,255,255,255"/>
      ...
      <text-format placeDirectionSymbol="0" useMaxLineLengthForAutoWrap="1" leftDirectionSymbol="&lt;" decimals="3" plussign="0" multilineAlign="3" wrapChar="" reverseDirectionSymbol="0" addDirectionSymbol="0" formatNumbers="0" autoWrapLength="0" rightDirectionSymbol=">"/>
      <placement xOffset="0" overrunDistance="0" rotationAngle="0" maxCurvedCharAngleOut="-25" repeatDistance="0" dist="0" distMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorType="PointGeometry" geometryGeneratorEnabled="0" yOffset="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" preserveRotation="1" offsetType="0" fitInPolygonOnly="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" placement="1" offsetUnits="MM" maxCurvedCharAngleIn="25" centroidInside="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" distUnits="MM" priority="5" repeatDistanceUnits="MM" geometryGenerator="" centroidWhole="0" quadOffset="4" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" placementFlags="10" overrunDistanceUnit="MM" layerType="PointGeometry"/>
  ...
  <DiagramLayerSettings priority="0" obstacle="0" linePlacementFlags="18" placement="0" dist="0" showAll="1" zIndex="0">
    <properties>
      <Option type="Map">
        <Option type="QString" name="name" value=""/>
        <Option name="properties"/>
  ...
  <aliases>
    ...
    <alias field="prog" name="Progressiva" index="1"/>
    <alias field="prog_reale" name="" index="2"/>
    <alias field="cod_strada" name="Codice strada" index="3"/>
  </aliases>
  <excludeAttributesWMS>
    <attribute>prog_reale</attribute>
  ...
  <defaults>
    ...
    <default field="prog" expression="" applyOnUpdate="0"/>
    <default field="prog_reale" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint constraints="0" unique_strength="0" field="prog" exp_strength="0" notnull_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="prog_reale" exp_strength="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="prog" desc=""/>
    <constraint exp="" field="prog_reale" desc=""/>
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column type="field" name="prog" hidden="0" width="-1"/>
      <column type="field" name="prog_reale" hidden="0" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    <field name="cod_strada" editable="0"/>
    <field name="gid" editable="0"/>
    <field name="prog" editable="0"/>
    <field name="prog_reale" editable="1"/>
  </editable>
  <labelOnTop>
    <field name="cod_strada" labelOnTop="0"/>
    <field name="gid" labelOnTop="0"/>
    <field name="prog" labelOnTop="0"/>
    <field name="prog_reale" labelOnTop="0"/>
  </labelOnTop>
  <widgets/>
