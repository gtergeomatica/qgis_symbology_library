...
<qgis simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="1" maxScale="0" labelsEnabled="0" minScale="50000" simplifyDrawingHints="1" readOnly="0" simplifyLocal="1" simplifyDrawingTol="1" version="3.12.3-București" styleCategories="AllStyleCategories" simplifyMaxScale="1">
  ...
  <renderer-v2 type="RuleRenderer" enableorderby="0" symbollevels="0" forceraster="0">
    <rules key="{2ab0c89b-2854-4b61-96de-a52f5cb2484a}">
      <rule key="{93b57b02-28c7-4d96-bf37-3f6e9a48a028}" scalemaxdenom="50000" scalemindenom="25000">
        <rule symbol="0" filter="&quot;d_tipologia&quot; = 1" key="{0a691ff2-e35a-4317-af9b-2b5711e1c56d}" label="Fiume"/>
        <rule symbol="1" filter="&quot;d_tipologia&quot; = 2" key="{909307ba-6886-41ab-9cfd-32190c7a3f67}" label="Torrente"/>
        <rule symbol="2" filter="&quot;d_tipologia&quot; = 3" key="{6b7904a2-6a1c-4ec9-afbb-8609daf8a6ce}" label="Canale di scolo"/>
        <rule symbol="3" filter="&quot;d_tipologia&quot; = 4" key="{4c3550ce-ac4b-4051-b2f4-61f07cd6e747}" label="Canale di bonifica"/>
        <rule symbol="4" filter="&quot;d_tipologia&quot; = 5" key="{c80d98cc-4e12-4708-857c-6c6ce4fd0afb}" label="Capofossi"/>
        <rule symbol="5" filter="&quot;d_tipologia&quot; = 6" key="{f60c0671-e5a7-4521-8df9-363068203b8a}" label="Scoline"/>
        <rule symbol="6" filter="ELSE" key="{b79bdf5d-dfbf-43c5-a4a6-b438dff63d98}" label="Altro o NC"/>
      </rule>
      <rule filter=" &quot;d_lato&quot;  =  'DX' " key="{fe90bbf5-5e47-4f17-8c7f-7c6235e5999e}" label="Lato destro" scalemaxdenom="25000" scalemindenom="1">
        <rule symbol="7" filter="&quot;d_tipologia&quot; = 1" key="{c8044456-4aa4-4aec-88e1-184db91d5db4}" label="Fiume"/>
        <rule symbol="8" filter="&quot;d_tipologia&quot; = 2" key="{8867705f-cb37-4308-9bd3-653d38cf74a1}" label="Torrente"/>
        <rule symbol="9" filter="&quot;d_tipologia&quot; = 3" key="{8a33d730-6893-4e4e-b667-391d0ea5405e}" label="Canale di scolo"/>
        <rule symbol="10" filter="&quot;d_tipologia&quot; = 4" key="{9cb19b41-b637-4e09-af9c-b131a497d552}" label="Canale di bonifica"/>
        <rule symbol="11" filter="&quot;d_tipologia&quot; = 5" key="{020da24f-3b42-4510-8055-a1c8d1a683d6}" label="Capofossi"/>
        <rule symbol="12" filter="&quot;d_tipologia&quot; = 6" key="{12c12369-6037-40b3-ae99-dcb43256cc40}" label="Scoline"/>
        <rule symbol="13" filter="ELSE" key="{f0c2fec4-9b63-49ae-94a2-3e57454484af}" label="Altro o NC"/>
      </rule>
      <rule filter=" &quot;d_lato&quot;  =  'SX' " key="{7220a27f-3218-4625-880d-8d3fc5a289ef}" label="Lato sinistro" scalemaxdenom="25000" scalemindenom="1">
        <rule symbol="14" filter="&quot;d_tipologia&quot; = 1" key="{331b352f-07ff-4a81-b5e9-fbde2e405576}" label="Fiume"/>
        <rule symbol="15" filter="&quot;d_tipologia&quot; = 2" key="{d01b3289-f5f9-433a-ac5b-d7df52f61afd}" label="Torrente"/>
        <rule symbol="16" filter="&quot;d_tipologia&quot; = 3" key="{490a13aa-9206-40ac-9987-bdc8181bd4cb}" label="Canale di scolo"/>
        <rule symbol="17" filter="&quot;d_tipologia&quot; = 4" key="{62a72a43-cf90-46ab-874c-f6916f02db2c}" label="Canale di bonifica"/>
        <rule symbol="18" filter="&quot;d_tipologia&quot; = 5" key="{6c0f7ca8-1303-49c2-a03b-0165da335a94}" label="Capofossi"/>
        <rule symbol="19" filter="&quot;d_tipologia&quot; = 6" key="{b872c95c-1fb2-4b7d-a8f2-54708b5f5de2}" label="Scoline"/>
        <rule symbol="20" filter="ELSE" key="{7d31702d-e86e-4aaa-8b30-f63a6b84efc0}" label="Altro o NC"/>
      </rule>
      <rule filter=" &quot;d_lato&quot;  =  'C' " key="{0b962732-da52-40d5-a03c-e1637a92e73f}" label="Centrale" scalemaxdenom="25000" scalemindenom="1">
        <rule symbol="21" filter="&quot;d_tipologia&quot; = 1" key="{e7131e1d-d4a0-4c82-884e-4bae291cd6e3}" label="Fiume"/>
        <rule symbol="22" filter="&quot;d_tipologia&quot; = 2" key="{632f4f13-9d15-4b67-a3c1-181450a5700f}" label="Torrente">
          <rule symbol="23" filter="&quot;d_tipologi&quot; = 3" key="{76b8e5c2-c1e0-461e-972d-e72a9b77b23a}" label="Canale di scolo"/>
        </rule>
        <rule symbol="24" filter="&quot;d_tipologia&quot; = 4" key="{f22d34b4-b54c-4036-bdf0-1ee27ce7d16d}" label="Canale di bonifica"/>
        <rule symbol="25" filter="&quot;d_tipologia&quot; = 5" key="{a528c949-d465-4071-a487-9c89c4fbdf65}" label="Capofossi"/>
        <rule symbol="26" filter="&quot;d_tipologia&quot; = 6" key="{5c91dc04-6cac-4fd8-94c5-9a13e7a62f19}" label="Scoline"/>
        <rule symbol="27" filter="ELSE" key="{dfc6c38b-774e-41a8-8382-d80f7ff58648}" label="Altro o NC"/>
      </rule>
      <rule filter=" &quot;d_lato&quot;  =  'E' " key="{f587d3f2-95a8-4931-8fa4-6bdd070a21fd}" label="Entrambi i lati" scalemaxdenom="25000" scalemindenom="1">
        <rule symbol="28" filter="&quot;d_tipologia&quot; = 1" key="{9ac6e9b9-33ef-439e-9bed-470058258834}" label="Fiume"/>
        <rule symbol="29" filter="&quot;d_tipologia&quot; = 2" key="{ef15bd46-6b16-4f74-8769-da8a229fd13c}" label="Torrente"/>
        <rule symbol="30" filter="&quot;d_tipologia&quot; = 3" key="{ccda3d8b-bdf0-4ac2-b57d-10de52cbbba2}" label="Canale di scolo"/>
        <rule symbol="31" filter="&quot;d_tipologia&quot; = 4" key="{0fded7fe-6084-46df-8d0b-8d9c84d57f41}" label="Canale di bonifica"/>
        <rule symbol="32" filter="&quot;d_tipologia&quot; = 5" key="{ae2b97b6-092a-42b0-973b-b9fd1e6de2d6}" label="Capofossi"/>
        <rule symbol="33" filter="&quot;d_tipologia&quot; = 6" key="{ae50bfe0-210f-401b-838f-26ffbfc0d414}" label="Scoline"/>
        <rule symbol="34" filter="ELSE" key="{e394b676-0ab3-4e9a-8e20-a48bed28f668}" label="Altro o NC"/>
      </rule>
    </rules>
    <symbols>
      <symbol type="line" name="0" force_rhr="0" alpha="1" clip_to_extent="1">
        <layer locked="0" pass="1" class="SimpleLine" enabled="1">
          ...
          <prop k="line_color" v="123,189,255,255"/>
        ...
        <layer locked="0" pass="0" class="MarkerLine" enabled="1">
          ...
          <symbol type="marker" name="@10@1" force_rhr="0" alpha="1" clip_to_extent="1">
            <layer locked="0" pass="0" class="SimpleMarker" enabled="1">
              ...
              <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
              <prop k="offset_unit" v="MM"/>
              <prop k="outline_color" v="123,189,255,255"/>
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option type="QString" name="Fiume" value="1"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Torrente" value="2"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Canale di scolo" value="3"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Canale di bonifica" value="4"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Capofossi" value="5"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Scoline" value="6"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Altro" value="7"/>
              </Option>
            </Option>
          </Option>
        </config>
  ...
  <aliases>
    ...
    <alias field="distparz_f" name="Distanza parziale finale" index="3"/>
    <alias field="prog_fin" name="Progressiva finale" index="4"/>
    <alias field="d_origine" name="Origine del dato" index="5"/>
    <alias field="cod_strada" name="Codice strada" index="6"/>
    <alias field="datains" name="Data inserimento" index="7"/>
    <alias field="dataagg" name="Data aggiornamento" index="8"/>
    <alias field="note_" name="Note" index="9"/>
    <alias field="d_tipologia" name="Tipologia" index="10"/>
    <alias field="dist_ciglio_cm" name="Distanza dal ciglio (cm)" index="11"/>
    <alias field="id" name="" index="12"/>
    <alias field="prog_ini_reale" name="" index="13"/>
    <alias field="prog_fin_reale" name="" index="14"/>
    <alias field="prog_ini_storico" name="" index="15"/>
    <alias field="prog_fin_storico" name="" index="16"/>
    <alias field="data_elimi" name="" index="17"/>
  ...
  <defaults>
    ...
    <default field="dist_ciglio_cm" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint constraints="0" unique_strength="0" field="dist_ciglio_cm" exp_strength="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="dist_ciglio_cm" desc=""/>
  ...
  <attributetableconfig sortExpression="&quot;note_&quot;" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column type="field" name="dist_ciglio_cm" hidden="0" width="-1"/>
