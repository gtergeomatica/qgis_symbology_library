...
<qgis simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="1" maxScale="0" labelsEnabled="0" minScale="50000" simplifyDrawingHints="1" readOnly="0" simplifyLocal="1" simplifyDrawingTol="1" version="3.12.3-București" styleCategories="AllStyleCategories" simplifyMaxScale="1">
  ...
  <renderer-v2 type="RuleRenderer" enableorderby="0" symbollevels="0" forceraster="0">
    <rules key="{26deb5cc-5f7d-4a7c-ab3a-9c3220c7708a}">
      <rule symbol="0" filter="&quot;d_tipo&quot; = 1" key="{e7981e8d-49e2-40b0-a679-fbc47dfbc364}" label="Doppio senso di marcia"/>
      <rule symbol="1" filter="&quot;d_tipo&quot; = 2" key="{17bccc1f-9fa1-4c3e-a845-e8a05818edb2}" label="Senso unico dalla giunzione iniziale alla giunzione finale"/>
      <rule symbol="2" filter="&quot;d_tipo&quot; = 3" key="{8a3c352c-2d75-4caf-8e1f-a01f18cb691f}" label="Senso unico dalla giunzione finale alla giunzione iniziale"/>
      <rule symbol="3" filter="&quot;d_tipo&quot; = 4" key="{89f6bce0-f5a5-41ea-85d9-0bfb89dfbf8c}" label="Divieto di transito nei due sensi"/>
      <rule symbol="4" filter="ELSE" key="{8fecd8e0-d46b-4422-bc75-544730b05069}" label="Altro o NC"/>
    </rules>
    <symbols>
        ...
        <layer locked="0" pass="0" class="MarkerLine" enabled="1">
          ...
          <symbol type="marker" name="@0@0" force_rhr="0" alpha="1" clip_to_extent="1">
            <layer locked="0" pass="0" class="SimpleMarker" enabled="1">
              ...
              <prop k="offset" v="2.59999999999999964,0"/>
              <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
              <prop k="offset_unit" v="MM"/>
            ...
            <layer locked="0" pass="0" class="SimpleMarker" enabled="1">
              ...
              <prop k="joinstyle" v="bevel"/>
              <prop k="name" v="arrowhead"/>
              <prop k="offset" v="2.39999999999999991,0"/>
              <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
              <prop k="offset_unit" v="MM"/>
              <prop k="outline_color" v="0,0,0,255"/>
              <prop k="outline_style" v="solid"/>
        ...
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              ...
              <Option type="Map">
                <Option type="QString" name="Doppio senso di marcia" value="1"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Senso unico dalla giunzione iniziale a quella finale" value="2"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Senso unico dalla giunzione finale a quella iniziale" value="3"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Divieto di transito nei due sensi" value="4"/>
              </Option>
            </Option>
          </Option>
        </config>
  ...
  <attributetableconfig sortExpression="&quot;d_tipo&quot;" actionWidgetStyle="dropDown" sortOrder="1">
    <columns>
      <column type="field" name="d_lato" hidden="0" width="-1"/>
      <column type="field" name="d_tipo" hidden="0" width="142"/>
      <column type="field" name="distparz_i" hidden="0" width="98"/>
