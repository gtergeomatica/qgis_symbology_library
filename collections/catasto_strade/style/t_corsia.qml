...
<qgis simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="1" maxScale="0" labelsEnabled="0" minScale="50000" simplifyDrawingHints="1" readOnly="0" simplifyLocal="1" simplifyDrawingTol="1" version="3.12.3-București" styleCategories="AllStyleCategories" simplifyMaxScale="1">
  ...
  <renderer-v2 type="RuleRenderer" enableorderby="0" symbollevels="0" forceraster="0">
    <rules key="{f47be1eb-03f5-4a15-8eb3-a25e92dde028}">
      <rule symbol="0" filter="&quot;d_tipo_corsia&quot; = 'A'" key="{e969a888-5218-42e8-8ecc-bfb1eb2f548a}" label="Corsia di marcia"/>
      <rule symbol="1" filter="&quot;d_tipo_corsia&quot; = 'B'" key="{7221124c-03fd-4428-903d-57ebd2eb3834}" label="Corsia riservata"/>
      <rule symbol="2" filter="&quot;d_tipo_corsia&quot; = 'C'" key="{ff7d7bbd-32c0-4040-a317-98f406f28b3f}" label="Corsia specializzata"/>
      <rule symbol="3" filter="&quot;d_tipo_corsia&quot; = 'D'" key="{d65b1eaf-788c-4605-9146-6c146631992e}" label="Corsia di emergenza"/>
      <rule symbol="4" filter="ELSE" key="{6e2a783e-c060-4752-8466-7feb7255a986}" label="Altro o NC"/>
    </rules>
    <symbols>
      ...
      <symbol type="line" name="1" force_rhr="0" alpha="1" clip_to_extent="1">
        <layer locked="1" pass="0" class="SimpleLine" enabled="1">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="round"/>
          <prop k="line_color" v="255,200,1,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="2.26"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
        ...
        <layer locked="0" pass="0" class="MarkerLine" enabled="1">
          ...
          <symbol type="marker" name="@4@1" force_rhr="0" alpha="1" clip_to_extent="1">
            <layer locked="0" pass="0" class="SimpleMarker" enabled="1">
              ...
              <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
              <prop k="offset_unit" v="MM"/>
              <prop k="outline_color" v="124,124,124,255"/>
  ...
  <fieldConfiguration>
    ...
    <field name="d_tipo_corsia">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option type="QString" name="Corsia di marcia" value="A"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Corsia riservata" value="B"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Corsia specializzata" value="C"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Corsia di emergenza" value="D"/>
              </Option>
              <Option type="Map">
  ...
  <aliases>
    ...
    <alias field="d_tipo_corsia" name="Tipologia corsia" index="1"/>
    <alias field="largh_corsia_cm" name="Larghezza (cm)" index="2"/>
    <alias field="numero_corsie" name="Numero corsie" index="3"/>
    ...
    <alias field="note_" name="Note" index="15"/>
  ...
  <defaults>
    ...
    <default field="d_tipo_corsia" expression="" applyOnUpdate="0"/>
    <default field="largh_corsia_cm" expression="" applyOnUpdate="0"/>
    <default field="numero_corsie" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint constraints="1" unique_strength="0" field="d_tipo_corsia" exp_strength="0" notnull_strength="1"/>
    <constraint constraints="0" unique_strength="0" field="largh_corsia_cm" exp_strength="0" notnull_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="numero_corsie" exp_strength="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="d_tipo_corsia" desc=""/>
    <constraint exp="" field="largh_corsia_cm" desc=""/>
    <constraint exp="" field="numero_corsie" desc=""/>
  ...
  <attributetableconfig sortExpression="&quot;d_tipo_corsia&quot;" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      <column type="field" name="d_lato" hidden="0" width="-1"/>
      <column type="field" name="d_tipo_corsia" hidden="0" width="166"/>
      <column type="field" name="largh_corsia_cm" hidden="0" width="150"/>
      <column type="field" name="numero_corsie" hidden="0" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="d_tipo_corsia" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field name="d_tipo_corsia" labelOnTop="0"/>
