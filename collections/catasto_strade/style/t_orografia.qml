...
<qgis simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="1" maxScale="0" labelsEnabled="0" minScale="50000" simplifyDrawingHints="1" readOnly="0" simplifyLocal="1" simplifyDrawingTol="1" version="3.12.3-București" styleCategories="AllStyleCategories" simplifyMaxScale="1">
  ...
  <renderer-v2 type="categorizedSymbol" enableorderby="0" attr="d_classi" symbollevels="0" forceraster="0">
    <categories>
      <category symbol="0" render="true" label="0-200 strada di pianura" value="1"/>
      <category symbol="1" render="true" label="200-600 strada di collina" value="2"/>
      <category symbol="2" render="true" label=">600 strada di montagna" value="3"/>
      <category symbol="3" render="true" label="NC" value=""/>
    </categories>
    <symbols>
      <symbol type="line" name="0" force_rhr="0" alpha="1" clip_to_extent="1">
        <layer locked="0" pass="0" class="SimpleLine" enabled="1">
          ...
          <prop k="line_color" v="104,85,0,255"/>
    ...
    <source-symbol>
      <symbol type="line" name="0" force_rhr="0" alpha="1" clip_to_extent="1">
        <layer locked="0" pass="0" class="SimpleLine" enabled="1">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="42,42,181,255"/>
          <prop k="line_style" v="solid"/>
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option type="QString" name="0-200 strada di pianura" value="1"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="200-600 strada di collina" value="2"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name=">600 strada di montagna" value="3"/>
              </Option>
              <Option type="Map">
  ...
  <aliases>
    ...
    <alias field="d_classi" name="Classe" index="1"/>
  ...
  <attributetableconfig sortExpression="&quot;d_classi&quot;" actionWidgetStyle="dropDown" sortOrder="1">
    <columns>
