...
<qgis simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="1" maxScale="250" labelsEnabled="1" minScale="5000" simplifyDrawingHints="0" readOnly="0" simplifyLocal="1" simplifyDrawingTol="1" version="3.12.3-București" styleCategories="AllStyleCategories" simplifyMaxScale="1">
  <flags>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <placement xOffset="0" overrunDistance="0" rotationAngle="0" maxCurvedCharAngleOut="-25" repeatDistance="0" dist="0" distMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorType="PointGeometry" geometryGeneratorEnabled="0" yOffset="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" preserveRotation="1" offsetType="0" fitInPolygonOnly="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" placement="0" offsetUnits="MM" maxCurvedCharAngleIn="25" centroidInside="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" distUnits="MM" priority="5" repeatDistanceUnits="MM" geometryGenerator="" centroidWhole="0" quadOffset="4" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" placementFlags="10" overrunDistanceUnit="MM" layerType="PointGeometry"/>
