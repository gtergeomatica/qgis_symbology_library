...
<qgis simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="1" maxScale="0" labelsEnabled="0" minScale="50000" simplifyDrawingHints="1" readOnly="0" simplifyLocal="1" simplifyDrawingTol="1" version="3.12.3-București" styleCategories="AllStyleCategories" simplifyMaxScale="1">
  ...
  <renderer-v2 type="categorizedSymbol" enableorderby="0" attr="d_grado" symbollevels="0" forceraster="0">
    <categories>
      <category symbol="0" render="true" label="I categoria" value="1"/>
      <category symbol="1" render="true" label="II categoria" value="2"/>
      <category symbol="2" render="true" label="III categoria" value="3"/>
      <category symbol="3" render="true" label="IV categoria" value="4"/>
      <category symbol="4" render="true" label="Non sismico" value="5"/>
      <category symbol="5" render="true" label="NC" value=""/>
    </categories>
    <symbols>
      ...
      <symbol type="line" name="1" force_rhr="0" alpha="1" clip_to_extent="1">
        <layer locked="0" pass="0" class="SimpleLine" enabled="1">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="255,136,0,255"/>
          <prop k="line_style" v="dash dot dot"/>
          <prop k="line_width" v="0.66"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
      ...
      <symbol type="line" name="3" force_rhr="0" alpha="1" clip_to_extent="1">
        <layer locked="0" pass="0" class="SimpleLine" enabled="1">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="201,236,2,255"/>
          <prop k="line_style" v="dash dot dot"/>
          <prop k="line_width" v="0.66"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
      ...
      <symbol type="line" name="4" force_rhr="0" alpha="1" clip_to_extent="1">
        <layer locked="0" pass="0" class="SimpleLine" enabled="1">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="0,188,34,255"/>
          <prop k="line_style" v="dash dot dot"/>
          <prop k="line_width" v="0.66"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
    ...
    <source-symbol>
      <symbol type="line" name="0" force_rhr="0" alpha="1" clip_to_extent="1">
        <layer locked="0" pass="0" class="SimpleLine" enabled="1">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="145,211,183,255"/>
          <prop k="line_style" v="solid"/>
        ...
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option type="QString" name="I categoria" value="1"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="II categoria" value="2"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="III categoria" value="3"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="IV categoria" value="4"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Non sismico" value="5"/>
              </Option>
            </Option>
          </Option>
        </config>
  ...
  <aliases>
    <alias field="d_grado" name="Grado" index="0"/>
    <alias field="distparz_i" name="Distanza parziale iniziale" index="1"/>
    <alias field="prog_ini" name="Progressiva iniziale" index="2"/>
    <alias field="prog_ini_storico" name="" index="3"/>
    <alias field="distparz_f" name="Distanza parziale finale" index="4"/>
    <alias field="prog_fin" name="Progressiva finale" index="5"/>
    <alias field="prog_fin_storico" name="" index="6"/>
    <alias field="d_lato" name="Lato" index="7"/>
  ...
  <defaults>
    <default field="d_grado" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    <constraint constraints="1" unique_strength="0" field="d_grado" exp_strength="0" notnull_strength="1"/>
  ...
  <constraintExpressions>
    <constraint exp="" field="d_grado" desc=""/>
  ...
  <attributetableconfig sortExpression="&quot;d_grado&quot;" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      <column type="field" name="d_grado" hidden="0" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <labelOnTop>
    ...
    <field name="d_grado" labelOnTop="0"/>
