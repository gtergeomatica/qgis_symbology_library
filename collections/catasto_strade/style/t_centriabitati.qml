...
<qgis simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="1" maxScale="0" labelsEnabled="0" minScale="50000" simplifyDrawingHints="1" readOnly="0" simplifyLocal="1" simplifyDrawingTol="1" version="3.12.3-București" styleCategories="AllStyleCategories" simplifyMaxScale="1">
    ...
    <symbols>
      <symbol type="line" name="0" force_rhr="0" alpha="1" clip_to_extent="1">
        <layer locked="0" pass="0" class="SimpleLine" enabled="1">
          ...
          <prop k="line_color" v="190,0,0,255"/>
  ...
  <fieldConfiguration>
    ...
    <field name="d_popolazione">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option type="QString" name="&lt; 10000 ab." value="0"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name=">10000 ab." value="1"/>
              </Option>
              <Option type="Map">
  ...
  <aliases>
    <alias field="nome_centro_attrav" name="Centro attraversato" index="0"/>
    <alias field="codice_istat" name="Codice istat" index="1"/>
    <alias field="d_popolazione" name="Popolazione" index="2"/>
    <alias field="numero_delibera" name="Numero delibera" index="3"/>
    <alias field="data_delibera" name="Data delibera" index="4"/>
    <alias field="d_lato" name="Lato" index="5"/>
    <alias field="distparz_i" name="Distanza parziale iniziale" index="6"/>
    <alias field="prog_ini" name="Progressiva iniziale" index="7"/>
    <alias field="prog_ini_storico" name="" index="8"/>
    <alias field="distparz_f" name="Distanza parziale finale" index="9"/>
    <alias field="prog_fin" name="Progressiva finale" index="10"/>
    <alias field="prog_fin_storico" name="" index="11"/>
    <alias field="d_origine" name="Origine del dato" index="12"/>
    <alias field="cod_strada" name="Codice strada" index="13"/>
    <alias field="datains" name="Data inserimento" index="14"/>
    <alias field="dataagg" name="Data aggiornamento" index="15"/>
    <alias field="data_elimi" name="Data eliminazione" index="16"/>
    <alias field="note_" name="Note" index="17"/>
    <alias field="id" name="" index="18"/>
    <alias field="prog_ini_reale" name="" index="19"/>
    <alias field="prog_fin_reale" name="" index="20"/>
    <alias field="login" name="Utente ultima modifica" index="21"/>
    <alias field="lunghezza" name="Lunghezza geometria (m)" index="22"/>
  </aliases>
  ...
  <defaults>
    <default field="nome_centro_attrav" expression="" applyOnUpdate="0"/>
    <default field="codice_istat" expression="" applyOnUpdate="0"/>
    <default field="d_popolazione" expression="" applyOnUpdate="0"/>
    <default field="numero_delibera" expression="" applyOnUpdate="0"/>
    <default field="data_delibera" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    <constraint constraints="0" unique_strength="0" field="nome_centro_attrav" exp_strength="0" notnull_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="codice_istat" exp_strength="0" notnull_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="d_popolazione" exp_strength="0" notnull_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="numero_delibera" exp_strength="0" notnull_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="data_delibera" exp_strength="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    <constraint exp="" field="nome_centro_attrav" desc=""/>
    <constraint exp="" field="codice_istat" desc=""/>
    <constraint exp="" field="d_popolazione" desc=""/>
    <constraint exp="" field="numero_delibera" desc=""/>
    <constraint exp="" field="data_delibera" desc=""/>
  ...
  <attributetableconfig sortExpression="&quot;d_origine&quot;" actionWidgetStyle="dropDown" sortOrder="1">
    <columns>
      <column type="field" name="nome_centro_attrav" hidden="0" width="160"/>
      <column type="field" name="codice_istat" hidden="0" width="-1"/>
      <column type="field" name="d_popolazione" hidden="0" width="-1"/>
      <column type="field" name="numero_delibera" hidden="0" width="-1"/>
      <column type="field" name="data_delibera" hidden="0" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="codice_istat" editable="1"/>
    <field name="d_lato" editable="1"/>
    <field name="d_origine" editable="1"/>
    <field name="d_popolazione" editable="1"/>
    <field name="data_delibera" editable="1"/>
    ...
    <field name="nome_centro_attrav" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field name="codice_istat" labelOnTop="0"/>
    <field name="d_lato" labelOnTop="0"/>
    <field name="d_origine" labelOnTop="0"/>
    <field name="d_popolazione" labelOnTop="0"/>
    <field name="data_delibera" labelOnTop="0"/>
    ...
    <field name="nome_centro_attrav" labelOnTop="0"/>
