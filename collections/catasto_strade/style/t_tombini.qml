...
<qgis simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="1" maxScale="0" labelsEnabled="0" minScale="25000" simplifyDrawingHints="0" readOnly="0" simplifyLocal="1" simplifyDrawingTol="1" version="3.12.3-București" styleCategories="AllStyleCategories" simplifyMaxScale="1">
  ...
  <renderer-v2 type="categorizedSymbol" enableorderby="0" attr="d_tipologia" symbollevels="0" forceraster="0">
    <categories>
      <category symbol="0" render="true" label="Tombino" value="1"/>
      <category symbol="1" render="true" label="Tombino con scivolo" value="2"/>
      <category symbol="2" render="true" label="Altro" value="3"/>
    </categories>
    <symbols>
  ...
  <fieldConfiguration>
        ...
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              ...
              <Option type="Map">
                <Option type="QString" name="Tombino" value="1"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Tombino con scivolo" value="2"/>
              </Option>
            </Option>
          </Option>
        </config>
    ...
    <field name="d_tipo_materiale">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option type="QString" name="c.a." value="Ca"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Calcestruzzo" value="Cls"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Metallo" value="Me"/>
              </Option>
              <Option type="Map">
                <Option type="QString" name="Muratura" value="Mr"/>
              </Option>
              <Option type="Map">
  ...
  <aliases>
    ...
    <alias field="d_tipologia" name="Tipologia" index="8"/>
    <alias field="largh_max_cm" name="Larghezza massima (cm)" index="9"/>
    <alias field="id" name="" index="10"/>
    <alias field="login" name="Utente ultima modifica" index="11"/>
    <alias field="denom_uff" name="Denominazione ufficiale" index="12"/>
    <alias field="denom_conv" name="Denominazione convenzionale" index="13"/>
    <alias field="altezza_cm" name="Altezza [cm]" index="14"/>
    <alias field="lunghezza_cm" name="Lunghezza [cm]" index="15"/>
    <alias field="d_tipo_materiale" name="Materiale" index="16"/>
    <alias field="d_stato" name="Stato" index="17"/>
    <alias field="data_costruzione" name="Data costruzione" index="18"/>
    <alias field="strategico" name="Strategico" index="19"/>
    <alias field="scheda_tecnica" name="Scheda tecnica" index="20"/>
    <alias field="foto_aggiornamenti" name="Foto aggiornamenti" index="21"/>
  </aliases>
  ...
  <defaults>
    ...
    <default field="largh_max_cm" expression="" applyOnUpdate="0"/>
    ...
    <default field="altezza_cm" expression="" applyOnUpdate="0"/>
    <default field="lunghezza_cm" expression="" applyOnUpdate="0"/>
    <default field="d_tipo_materiale" expression="" applyOnUpdate="0"/>
    ...
    <default field="foto_aggiornamenti" expression="" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    ...
    <constraint constraints="3" unique_strength="1" field="largh_max_cm" exp_strength="0" notnull_strength="1"/>
    ...
    <constraint constraints="0" unique_strength="0" field="altezza_cm" exp_strength="0" notnull_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="lunghezza_cm" exp_strength="0" notnull_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="d_tipo_materiale" exp_strength="0" notnull_strength="0"/>
    ...
    <constraint constraints="0" unique_strength="0" field="foto_aggiornamenti" exp_strength="0" notnull_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" field="foto_aggiornamenti" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
    <defaultAction key="Canvas" value="{00000000-0000-0000-0000-000000000000}"/>
  </attributeactions>
  <attributetableconfig sortExpression="&quot;largh_max_cm&quot;" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column type="field" name="largh_max_cm" hidden="0" width="105"/>
      ...
      <column type="field" name="altezza_cm" hidden="0" width="-1"/>
      <column type="field" name="lunghezza_cm" hidden="0" width="-1"/>
      <column type="field" name="d_tipo_materiale" hidden="0" width="-1"/>
      ...
      <column type="field" name="foto_aggiornamenti" hidden="0" width="-1"/>
    </columns>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <attributeEditorField name="denom_uff" showLabel="1" index="12"/>
    <attributeEditorField name="denom_conv" showLabel="1" index="13"/>
    <attributeEditorField name="d_tipologia" showLabel="1" index="8"/>
    <attributeEditorField name="altezza_cm" showLabel="1" index="14"/>
    <attributeEditorField name="lunghezza_cm" showLabel="1" index="15"/>
    <attributeEditorField name="largh_max_cm" showLabel="1" index="9"/>
    <attributeEditorField name="d_tipo_materiale" showLabel="1" index="16"/>
    <attributeEditorField name="d_lato" showLabel="1" index="0"/>
    <attributeEditorField name="prog_ini" showLabel="1" index="1"/>
    <attributeEditorField name="d_origine" showLabel="1" index="2"/>
    <attributeEditorField name="cod_strada" showLabel="1" index="3"/>
    <attributeEditorField name="data_ins" showLabel="1" index="4"/>
    <attributeEditorField name="data_agg" showLabel="1" index="5"/>
    <attributeEditorField name="data_elimi" showLabel="1" index="6"/>
    <attributeEditorField name="note" showLabel="1" index="7"/>
    <attributeEditorField name="id" showLabel="1" index="10"/>
    <attributeEditorField name="login" showLabel="1" index="11"/>
    <attributeEditorField name="d_stato" showLabel="1" index="17"/>
    <attributeEditorField name="data_costruzione" showLabel="1" index="18"/>
    <attributeEditorField name="strategico" showLabel="1" index="19"/>
    <attributeEditorField name="scheda_tecnica" showLabel="1" index="20"/>
    <attributeEditorField name="foto_aggiornamenti" showLabel="1" index="21"/>
  </attributeEditorForm>
  <editable>
    <field name="altezza_cm" editable="1"/>
    <field name="cod_strada" editable="1"/>
    <field name="d_lato" editable="1"/>
    <field name="d_origine" editable="1"/>
    <field name="d_stato" editable="1"/>
    <field name="d_tipo_materiale" editable="1"/>
    ...
    <field name="foto_aggiornamenti" editable="1"/>
    <field name="id" editable="1"/>
    <field name="largh_max_cm" editable="1"/>
  ...
  <labelOnTop>
    <field name="altezza_cm" labelOnTop="0"/>
    ...
    <field name="d_tipo_materiale" labelOnTop="0"/>
    ...
    <field name="foto_aggiornamenti" labelOnTop="0"/>
    <field name="id" labelOnTop="0"/>
    <field name="largh_max_cm" labelOnTop="0"/>
